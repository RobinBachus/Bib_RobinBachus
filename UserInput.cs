...
namespace Bib_RobinBachus
{
    ...
    internal static class UserInput
    {
        ...
        /// it checks if the input is within the allowed values. If it is, it returns the input value and null for parsed value.
        ...
        /// <returns>A tuple containing the user's input value and the parsed value. If the input is not parseable to the type T but is within the allowed values, the parsed value is null.</returns>
        ...
        /// If the default path is not provided or the user chooses not to use it, the user is prompted to enter a new file path.
        ...
        public static string? PromptPath(string? defaultPath = null)
        {
            ...
            bool createFile = PromptBool($"Bestand niet gevonden, wil je een nieuw bestand aanmaken? ({Path.GetFullPath(path)})");
            if (!createFile)
            {
